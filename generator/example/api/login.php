...
*/
//sanitize datas
$login = trim($data->login); #replace mail by the sended variable in the posted JSON message
...
$query = "  SELECT id, password # do you want to store more information in token. add them here and bellow
            ...
            WHERE login = \"$login\" #and/or the where clause (check if your attribut is called email or mail or other)
            ";
